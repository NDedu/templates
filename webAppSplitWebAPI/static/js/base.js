let _apiUrl = new URL(document.body.dataset.api);
_apiUrl.hostname = location.hostname;
let apiPort = _apiUrl.origin;
...
function sendWs(data) {
    if (socket && socket.readyState === WebSocket.OPEN) {
        try {
            ...
            wsQueue.push(data); // Rescue the message
        }
    } else {
        wsQueue.push(data);
    }
