...
func (app *application) EditBook(w http.ResponseWriter, r *http.Request) {
	...
	book, err := app.db.Book.GetByUUID(r.Context(), payload.UUID)
	if err != nil {
	...
	err = app.db.Book.Update(r.Context(), book)
	if err != nil {
...
func (app *application) DeleteBook(w http.ResponseWriter, r *http.Request) {
	...
	err = app.db.Book.Delete(r.Context(), book.ID)
	if err != nil {
...
func (app *application) AddBook(w http.ResponseWriter, r *http.Request) {
	...
	id, err := app.db.Book.Insert(r.Context(), book)
	if err != nil {
